...
const TableViews = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].table`
  ...
  @media only screen and (min-width: 320) and (max-width: 429px) {
  ...
  @media only screen and (min-width: 430) (max-width: 578px) {
    td {font-size: 0.5rem; }
    td a { font-size: 0.5rem; }
    td img{ width: 15px;}
    th { font-size: 0.5rem; }
...
//# sourceMappingURL=main.a487e1d3af38fabfa9ad.hot-update.js.map